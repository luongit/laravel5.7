tinymce.init({
    ...
    forced_root_block : '',
    lna_file_title:"Quản lý ảnh",	
    // file_browser_callback: function(field_name, url, type, win) {
    //     $('#'+field_name).val('dsdsdsdsds');
    // }
    // external_filemanager_path: app._url + "/file/",
    external_lna_file_path: app._url + "/admin/media",
    external_plugins: { 
        // "filemanager" : ap._url + "/file/pplugin.min.js",
        "lna_file" : app._url + "/public/dist/js/file.js"
    },
...
tinymce.init({
	...
	external_filemanager_path: app._url + "/file/",
    external_plugins: { 
        "filemanager" : app._url + "/file/plugin.min.js"
    },
    filemanager_access_key:app._akey
