...
! function (e, a, t) {
			...
			contextActions: {
				...
				edit_img: function (a) {
					var t = a.attr("data-name"),
						n = e("#base_url").val() + e("#cur_dir").val() + t,
						i = e("#aviary_img");
				...
				select: function (a) {
					...
					if (1 == r && (n = n.replace(e("#base_url").val(), "")), t = 1 == e("#popup").val() ? window.opener : window.parent, "" != i)
						if (1 == e("#crossdomain").val()) t.postMessage({
							...
							o.val(n).trigger("change"), "function" == typeof t.responsive_filemanager_callback && t.responsive_filemanager_callback(i), _()
						}
					else apply_any(n)
				},
				copy: function (e) {
	...
	e(document).ready(function () {
		if (e("#rfmDropzone").on("click", ".dz-success .dz-detail", function () {
			...
			}), T && U.makeContextMenu(), "undefined" != typeof Storage) {
		...
		if (e("#full-img").on("click", function () {
			...
			}), U.bindGridEvents(), parseInt(e("#file_number").val()) > parseInt(e("#file_number_limit_js").val())) var l = !1;
		else var l = !0;
		if (U.makeSort(l), U.makeFilters(l), e("#info").on("click", function () {
		...
		var i = e("#cur_dir").val(),
			r = (e("#subdir").val(), e("#base_url").val()),
			o = a.substr(0, a.lastIndexOf(".")),
			l = a.split(".").pop();
		l = l.toLowerCase();
		var c = "",
			s = ["ogg", "mp3", "wav"],
			d = ["mp4", "ogg", "webm"],
			p = e("#return_relative_url").val(),
			f = encodeURL((1 == p ? i : r + i) + a);
		if ("" != t)
			if (1 == e("#crossdomain").val()) n.postMessage({
				...
				var u = e("#" + t, n.document);
				u.val(f).trigger("change"), "function" == typeof n.responsive_filemanager_callback && n.responsive_filemanager_callback(t), _()
			}
		else e.inArray(l, ext_img) > -1 ? (f = f + "?" + (new Date).getTime(), c = '<img src="' + f + '" alt="' + o + '" />') : e.inArray(l, d) > -1 ? c = '<video controls source src="' + f + '" type="video/' + l + '">' + o + "</video>" : e.inArray(l, s) > -1 ? ("mp3" == l && (l = "mpeg"), c = '<audio controls src="' + f + '" type="audio/' + l + '">' + o + "</audio>") : c = '<a href="' + f + '" title="' + o + '">' + o + "</a>", 1 == e("#crossdomain").val() ? n.postMessage({
			sender: "responsivefilemanager",
			url: f,
			field_id: null,
			html: c
		}, "*") : parent.tinymce.majorVersion < 4 ? (parent.tinymce.activeEditor.execCommand("mceInsertContent", !1, c), parent.tinymce.activeEditor.windowManager.close(parent.tinymce.activeEditor.windowManager.params.mce_window_id)) : (parent.tinymce.activeEditor.insertContent(c), parent.tinymce.activeEditor.windowManager.close())
