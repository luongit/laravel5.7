! function (e, t) {
	...
	function v(e, t) {
		if (1 === t.nodeType && lt.hasData(e)) {
			var n, i, o, r = lt._data(e),
				s = lt._data(t, r),
				a = r.events;
			if (a) {
				delete s.handle, s.events = {};
				for (n in a)
					for (i = 0, o = a[n].length; o > i; i++) lt.event.add(t, n, a[n][i])
			}
	...
	function b(e, n) {
		...
		if (!s)
			for (s = [], i = e.childNodes || e; null != (o = i[r]); r++) !n || lt.nodeName(o, n) ? s.push(o) : lt.merge(s, b(o, n));
	...
	function $(e, t, n) {
		var i = !0,
			...
			r = dn(e),
			s = lt.support.boxSizing && "border-box" === lt.css(e, "boxSizing", !1, r);
		if (0 >= o || null == o) {
	...
	function z(e, t) {
		var n, i, o, r, s;
		for (o in e)
			if (i = lt.camelCase(o), r = t[i], n = e[o], lt.isArray(n) && (r = n[1], n = e[o] = n[0]), o !== i && (e[i] = n, delete e[o]), s = lt.cssHooks[i], s && "expand" in s) {
	...
	lt.fn = lt.prototype = {
		...
		init: function (e, n, i) {
			...
			if ("string" == typeof e) {
				...
				if (o[1]) {
					if (n = n instanceof lt ? n[0] : n, lt.merge(this, lt.parseHTML(o[1], n && n.nodeType ? n.ownerDocument || n : Q, !0)), ht.test(o[1]) && lt.isPlainObject(n))
		...
		var e, n, i, o, r, s, a = arguments[0] || {},
			...
			c = arguments.length,
			u = !1;
		for ("boolean" == typeof a && (u = a, a = arguments[1] || {}, l = 2), "object" == typeof a || lt.isFunction(a) || (a = {}), c === l && (a = this, --l); c > l; l++)
			if (null != (r = arguments[l]))
				for (o in r) e = a[o], i = r[o], a !== i && (u && i && (lt.isPlainObject(i) || (n = lt.isArray(i))) ? (n ? (n = !1, s = e && lt.isArray(e) ? e : []) : s = e && lt.isPlainObject(e) ? e : {}, a[o] = lt.extend(u, s, i)) : i !== t && (a[o] = i));
		return a
	}, lt.extend({
		...
		if (!U)
			...
			else if (Q.addEventListener) Q.addEventListener("DOMContentLoaded", xt, !1), e.addEventListener("load", xt, !1);
		else {
	...
	lt.Callbacks = function (e) {
			...
			p = {
				...
				remove: function () {
					return c && lt.each(arguments, function (e, t) {
						for (var i;
							(i = lt.inArray(t, c, i)) > -1;) c.splice(i, 1), n && (s >= i && s--, a >= i && a--)
					}), this
				},
				has: function (e) {
		...
		when: function (e) {
			...
			if (s > 1)
				for (t = new Array(s), n = new Array(s), i = new Array(s); s > o; o++) r[o] && lt.isFunction(r[o].promise) ? r[o].promise().done(c(o, i, r)).fail(l.reject).progress(c(o, n, t)) : --a;
	...
	var $t, Nt, _t = /[\t\r\n]/g,
		...
		At = /^(?:a|area)$/i,
		Mt = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,
	...
	lt.fn.extend({
		...
		addClass: function (e) {
			...
			if (l)
				for (t = (e || "").match(ut) || []; a > s; s++)
					if (n = this[s], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(_t, " ") : " ")) {
		...
		toggleClass: function (e, t) {
			...
			return this.each(lt.isFunction(e) ? function (n) {
				...
				if ("string" === n)
					for (var o, r = 0, s = lt(this), a = t, l = e.match(ut) || []; o = l[r++];) a = i ? a : !s.hasClass(o), s[a ? "addClass" : "removeClass"](o);
		...
		removeAttr: function (e, t) {
			var n, i, o = 0,
				r = t && t.match(ut);
			if (r && 1 === e.nodeType)
				for (; n = r[o++];) i = lt.propFix[n] || n, Mt.test(n) ? !Pt && Lt.test(n) ? e[lt.camelCase("default-" + n)] = e[i] = !1 : e[i] = !1 : lt.attr(e, n, ""), e.removeAttribute(Pt ? n : i)
		},
		attrHooks: {
			type: {
				set: function (e, t) {
		...
		get: function (e, n) {
			var i = lt.prop(e, n),
				...
				r = "boolean" == typeof i ? Ft && Pt ? null != o : Lt.test(n) ? e[lt.camelCase("default-" + n)] : !!o : e.getAttributeNode(n);
	...
	lt.event = {
			...
			remove: function (e, t, n, i, o) {
				...
				if (g && (u = g.events)) {
					for (t = (t || "").match(ut) || [""], c = t.length; c--;)
						if (a = zt.exec(t[c]) || [], h = m = a[1], f = (a[2] || "").split(".").sort(), h) {
			...
			trigger: function (n, i, o, r) {
				...
				if (l = d = o = o || Q, 3 !== o.nodeType && 8 !== o.nodeType && !jt.test(f + lt.event.triggered) && (f.indexOf(".") >= 0 && (m = f.split("."), f = m.shift(), m.sort()), a = f.indexOf(":") < 0 && "on" + f, n = n[lt.expando] ? n : new lt.Event(f, "object" == typeof n && n), n.isTrigger = !0, n.namespace = m.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = o), i = null == i ? [n] : lt.makeArray(i, [n]), u = lt.event.special[f] || {}, r || !u.trigger || u.trigger.apply(o, i) !== !1)) {
					...
					for (p = 0;
						(l = h[p++]) && !n.isPropagationStopped();) n.type = p > 1 ? c : u.bindType || f, s = (lt._data(l, "events") || {})[n.type] && lt._data(l, "handle"), s && s.apply(l, i), s = a && l[a], s && lt.acceptData(l) && s.apply && s.apply(l, i) === !1 && n.preventDefault();
			...
			dispatch: function (e) {
				...
				if (l[0] = e, e.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, e) !== !1) {
					for (a = lt.event.handlers.call(this, e, c), n = 0;
						(r = a[n++]) && !e.isPropagationStopped();)
						for (e.currentTarget = r.elem, s = 0;
							(o = r.handlers[s++]) && !e.isImmediatePropagationStopped();)(!e.namespace_re || e.namespace_re.test(o.namespace)) && (e.handleObj = o, e.data = o.data, i = ((lt.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l), i !== t && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
		...
		function (e, t) {
			...
			function w(e, t, n, i) {
				...
				if (!i && 1 === c.length) {
					...
					for (o = pt.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !T.relative[a = s.type]);)
						if ((l = T.find[a]) && (i = l(s.matches[0].replace(wt, xt), ht.test(r[0].type) && t.parentNode || t))) {
	...
	lt.fn.extend({
		...
		closest: function (e, t) {
			for (var n, i = 0, o = this.length, r = [], s = qt.test(e) || "string" != typeof e ? lt(e, t || this.context) : 0; o > i; i++)
	...
	an.optgroup = an.option, an.tbody = an.tfoot = an.colgroup = an.caption = an.thead, an.th = an.td, lt.fn.extend({
		...
		domManip: function (e, n, i) {
			...
			if (d && (c = lt.buildFragment(e, this[0].ownerDocument, !1, this), o = c.firstChild, 1 === c.childNodes.length && (c = o), o)) {
				...
				if (s)
					for (l = a[a.length - 1].ownerDocument, lt.map(a, m), u = 0; s > u; u++) r = a[u], on.test(r.type || "") && !lt._data(r, "globalEval") && lt.contains(l, r) && (r.src ? lt.ajax({
						url: r.src,
						type: "GET",
						dataType: "script",
						async: !1,
		...
		clone: function (e, t, n) {
			...
			if (lt.support.html5Clone || lt.isXMLDoc(e) || !Qt.test("<" + e.nodeName + ">") ? r = e.cloneNode(!0) : (cn.innerHTML = e.outerHTML, cn.removeChild(r = cn.firstChild)), !(lt.support.noCloneEvent && lt.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || lt.isXMLDoc(e)))
		...
		buildFragment: function (e, t, n, i) {
			for (var o, r, s, a, l, c, u, d = e.length, h = p(t), f = [], m = 0; d > m; m++)
				...
				if (!lt.support.leadingWhitespace && Kt.test(r) && f.push(t.createTextNode(Kt.exec(r)[0])), !lt.support.tbody)
					for (r = "table" !== l || Jt.test(r) ? "<table>" !== u[1] || Jt.test(r) ? 0 : a : a.firstChild, o = r && r.childNodes.length; o--;) lt.nodeName(c = r.childNodes[o], "tbody") && !c.childNodes.length && r.removeChild(c);
				for (lt.merge(f, a.childNodes), a.textContent = ""; a.firstChild;) a.removeChild(a.firstChild);
				a = h.lastChild
			} else f.push(t.createTextNode(r));
			for (a && h.removeChild(a), lt.support.appendChecked || lt.grep(b(f, "input"), w), m = 0; r = f[m++];)
				if ((!i || -1 === lt.inArray(r, i)) && (s = lt.contains(r.ownerDocument, r), a = b(h.appendChild(r), "script"), s && g(a), n))
					for (o = 0; r = a[o++];) on.test(r.type || "") && n.push(r);
			return a = null, h
		},
		cleanData: function (e, t) {
			for (var n, i, o, r, s = 0, a = lt.expando, l = lt.cache, c = lt.support.deleteExpando, u = lt.event.special; null != (n = e[s]); s++)
				if ((t || lt.acceptData(n)) && (o = n[a], r = o && l[o])) {
					if (r.events)
	...
	An = Wn.exec(Mn.toLowerCase()) || [], lt.fn.load = function (e, n, i) {
		...
		ajax: function (e, n) {
			...
			var o, r, s, a, l, c, u, d, p = lt.ajaxSetup({}, n),
				h = p.context || p,
				f = p.context && (h.nodeType || h.jquery) ? lt(h) : lt.event,
				m = lt.Deferred(),
					...
					l.send(n.hasContent && n.data || null), i = function (e, o) {
						...
						try {
							if (i && (o || 4 === l.readyState))
								if (i = t, s && (l.onreadystatechange = lt.noop, Jn && delete Kn[s]), o) 4 !== l.readyState && l.abort();
								else {
...
window.bootbox = bootbox,
		...
		function n(t, n) {
			...
			function ht(e) {
				for (var t = 0; t < Yt.length; t++)
					if (Yt[t].identifier == e) return Yt[t]
			}
			...
			var St = T || $ || !n.fallbackToMouseEvents,
				Dt = St ? $ ? E ? "MSPointerDown" : "pointerdown" : "touchstart" : "mousedown",
				At = St ? $ ? E ? "MSPointerMove" : "pointermove" : "touchmove" : "mousemove",
				Mt = St ? $ ? E ? "MSPointerUp" : "pointerup" : "touchend" : "mouseup",
				Lt = St ? null : "mouseleave",
				Pt = $ ? E ? "MSPointerCancel" : "pointercancel" : "touchcancel",
				Ft = 0,
				Ot = null,
				It = 0,
				Ht = 0,
	...
	function (e, t) {
		...
		var n, i, o = e,
			...
			q = function (e, t) {
				...
				if ("string" == typeof e && e) o = e.toLowerCase().split(/\s+/);
					...
					for (n in e) y.call(e, n) && "string" == typeof n && n && "function" == typeof e[n] && At.on(n, e[n]);
				if (o && o.length) {
					for (n = 0, i = o.length; i > n; n++) e = o[n].replace(/^on/, ""), r[e] = !0, O[e] || (O[e] = []), O[e].push(t);
					if (r.ready && P.ready && At.emit({
							type: "ready"
						}), r.error) {
			...
			U = function (e, t) {
				...
				if (0 === arguments.length) r = g(O);
					...
					for (n in e) y.call(e, n) && "string" == typeof n && n && "function" == typeof e[n] && At.off(n, e[n]);
				if (r && r.length)
			...
			G = function (e, t) {
				var n;
				if ("object" == typeof e && e && "undefined" == typeof t) n = e, At.clearData();
				else {
			...
			ct = function (e) {
				...
				switch (e.type) {
					...
					case "_mouseout":
						...
						break;
					case "_mousedown":
						Ct(t, z.activeClass), z.bubbleEvents === !0 && o && ut(C({}, e, {
							type: e.type.slice(1)
						}));
						break;
					case "_mouseup":
						kt(t, z.activeClass), z.bubbleEvents === !0 && o && ut(C({}, e, {
							type: e.type.slice(1)
						}));
						break;
					case "_click":
						i = null, z.bubbleEvents === !0 && o && ut(C({}, e, {
							type: e.type.slice(1)
						}));
						break;
					case "_mousemove":
						z.bubbleEvents === !0 && o && ut(C({}, e, {
							type: e.type.slice(1)
						}))
				}
			...
			ht = function () {
				var e, t = P.bridge,
					n = pt(t);
				if (!t) {
					var i = wt(o.location.host, z),
						s = "never" === i ? "none" : "all",
						a = yt(z),
						l = z.swfPath + vt(z.swfPath, z);
					n = dt();
		...
		var It = function (e) {
			...
			Ht = function (e, t) {
				var n, i, o, r = {},
					s = Lt[this.id] && Lt[this.id].handlers;
				if ("string" == typeof e && e) o = e.toLowerCase().split(/\s+/);
				else if ("object" == typeof e && e && "undefined" == typeof t)
			...
			Yt = function (e) {
				if ("object" == typeof e && e && e.type) {
					var t = st(e),
						n = Lt[this.id] && Lt[this.id].handlers["*"] || [],
						i = Lt[this.id] && Lt[this.id].handlers[e.type] || [],
						r = n.concat(i);
					if (r && r.length) {
						var s, a, l, c, u, d = this;
						for (s = 0, a = r.length; a > s; s++) l = r[s], c = d, "string" == typeof l && "function" == typeof o[l] && (l = o[l]), "object" == typeof l && l && "function" == typeof l.handleEvent && (c = l, l = l.handleEvent), "function" == typeof l && (u = C({}, e), at(l, c, [u], t))
